...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2022 at 10:15 PM
...
INSERT INTO `pemesanan` (`ID_PESAN`, `TANGGAL_PESAN`, `ID_BUNGA`, `ID_MEMBER`, `id_user`) VALUES
(4, '2022-12-06', 1, 1, 1);
...
--
ALTER TABLE `bunga`
  MODIFY `ID_BUNGA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
